using DocAnalyzer.Api.Attributes;
using DocAnalyzer.Application.DependencyInjection;
using DocAnalyzer.Domain.DependencyInjection;
using DocAnalyzer.Repository.DependencyInjection;
using DocAnalyzer.Repository.Middleware;
