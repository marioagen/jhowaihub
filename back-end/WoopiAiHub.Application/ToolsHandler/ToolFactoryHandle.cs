...
public class ToolFactoryHandler : IToolFactoryHandler
{
    ...
    public ToolFactoryHandler(ITenantCacheServices tenantCacheServices, IOptions<MessageQueues> messageQueues, IKeyGeneratorApi keyGeneratorApi, IConfiguration config)
    {
