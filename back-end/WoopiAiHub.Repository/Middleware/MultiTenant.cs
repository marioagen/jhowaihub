...
{
    /// <summary>
    /// Resolves the tenant database connection per request and enforces that authenticated users
    /// cannot override their JWT-bound tenant via the X-Tenant header.
    /// </summary>
