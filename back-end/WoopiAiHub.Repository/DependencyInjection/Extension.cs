...
namespace WoopiAiHub.Repository.DependencyInjection
{
    public static class Extension
    {
        public static IServiceCollection AddRepository(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<ITenantLlmModelSettingsRepository, TenantLlmModelSettingsRepository>();
            ...
            services.AddScoped<IDocumentAnonymizationRepository, DocumentAnonymizationRepository>();
