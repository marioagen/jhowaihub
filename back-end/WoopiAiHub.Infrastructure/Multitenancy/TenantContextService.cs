...
namespace WoopiAiHub.Infrastructure.Multitenancy
{
    public class TenantContextService : ITenantContextService
    {
        ...
        /// <summary>
        /// Asynchronously retrieves the database connection string for the specified tenant.
        /// </summary>
        /// <remarks>The returned connection string is generated by replacing a placeholder in the
        /// template connection string with the tenant's database name. Ensure that the template connection string is
        /// configured and contains the expected placeholder.</remarks>
        /// <param name="scope">The service scope used to resolve required services for tenant lookup. Must not be null.</param>
