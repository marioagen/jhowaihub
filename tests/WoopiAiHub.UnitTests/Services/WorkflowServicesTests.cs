...
namespace WoopiAiHub.UnitTests.Services
{
    public class WorkflowServicesTests
    {
        ...
        [Fact(DisplayName = "Test FindAllInternal returns workflows")]
        [Trait("FindAllInternal", "Success")]
        public void FindAllInternal_ReturnsInternalWorkflows()
        {
            // Arrange
            var expectedWorkflows = new List<WorkflowInternalDto>
            {
                new WorkflowInternalDto { Id = 1, Name = "Internal Workflow 1" },
                new WorkflowInternalDto { Id = 2, Name = "Internal Workflow 2" }
            };
            _workflowRepositoryMock.Setup(repo => repo.FindAllInternal())
            ...
            // Assert
            _workflowRepositoryMock.Verify(repo => repo.FindAllInternal(), Times.Once);
            Assert.Equal(expectedWorkflows, result);
        }

        [Fact(DisplayName = "Test FindModelById returns a workflow model")]
        [Trait("FindModelById", "Success")]
        public async Task FindModelById_WorkflowExists_ReturnsWorkflowModel()
        {
            // Arrange
            var workflowId = 1;
            var teamFixture = new TeamFixture();
            var team = teamFixture.CreateValidTeam();
            var expectedWorkflow = new Workflow(workflowId, DateTime.Now, new List<Team> { team }, "Workflow Model 1");
            _workflowRepositoryMock.Setup(repo => repo.FindByIdReturnModelWithSteps(workflowId))
                .ReturnsAsync(expectedWorkflow);

            // Act
            var result = await _workflowServices.FindModelById(workflowId);

            // Assert
            _workflowRepositoryMock.Verify(repo => repo.FindByIdReturnModelWithSteps(workflowId), Times.Once);
            Assert.Equal(expectedWorkflow, result);
        }
        ...
        public void FindAllByUser_ValidUser_ReturnsWorkflows()
        {
            ...
            {
                new WorkflowDto { Id = 1, Name = "Workflow 1" }, new WorkflowDto { Id = 2, Name = "Workflow 2" }
            };
        ...
        {
            // Arrange
            var workflowPagedDto =
                new WorkflowPagedDto { Page = 1, OrderBy = filter, TeamId = 1, UserId = Guid.NewGuid() };
            var workflowList = new List<WorkflowDto> { new WorkflowDto() };

            _workflowRepositoryMock.Setup(repo => repo.FindAllWithFilter(workflowPagedDto))
        ...
        public async Task FindByProfileStep_ShouldReturnWorkflows_WhenSuccessful()
        {
            ...
            {
                new StepProfilePermission(1, 1, 1), new StepProfilePermission(1, 2, 1),
            };
        ...
        public async Task RemoveTeamWorkflowRelationship_ShouldRemoveWorkflows_AndUpdateTeam_WhenSuccessful()
        {
            ...
            {
                new TeamsWorkflowsDto { TeamId = 1, Workflows = new List<int> { 10, 20 } }
            };
            ...
            _workflowRepositoryMock.Verify(
                r => r.FindByIdsAsync(It.Is<ICollection<int>>(ids => ids.SequenceEqual(dto[0].Workflows))), Times.Once);
        ...
        public async Task UpdateTeamProfileRelationshipToWorkflow_ShouldStopEarly_WhenNoWorkflowsToRemove()
        {
            ...
            _workflowServicesMock
                ...
                .ReturnsAsync(new TeamsWorkflowsDto { TeamId = team.Id, Workflows = new List<int>() });
        ...
        [Fact(DisplayName =
            "VerifyWorkflowMatchInOtherTeamProfile should return only workflows not matched by other profiles")]
        ...
        public async Task VerifyWorkflowMatchInOtherTeamProfile_ShouldReturnOnlyWorkflowsNotFoundInOtherProfiles()
        {
            ...
            // Team
            var team = new Team("Justice League", teamId, DateTime.UtcNow) { Profiles = new List<Profile>() };
        ...
        {
            // Arrange
            var phase1Dto = new WorkflowPhase1Dto { Name = "", Teams = new List<int> { 1 } };
        ...
        {
            // Arrange
            var phase1Dto = new WorkflowPhase1Dto { Name = "Test Workflow", Teams = new List<int>() };
        ...
        {
            // Arrange
            var phase1Dto = new WorkflowPhase1Dto { Name = "Test Workflow", Teams = new List<int> { 1, 2 } };
        ...
        {
            // Arrange
            var phase2Dto = new WorkflowPhase2Dto { WorkflowId = 1, Steps = new List<StepPhase2Dto>() };
        ...
        {
            // Arrange
            var phase3Dto = new WorkflowPhase3Dto { WorkflowId = 1, Steps = new List<StepPhase3Dto>() };
        ...
        [Fact(DisplayName = "UpdatePhase3 should throw AppException when tool not found")]
        [Trait("UpdatePhase3", "Fail")]
        public async Task UpdatePhase3_ToolNotFound_ThrowsAppException()
        {
            // Arrange
            ...
            _toolRepositoryMock.Setup(x => x.FindByIdAsync(It.IsAny<int>()))
        ...
        [Fact(DisplayName =
            "UpdatePhase3 should throw AppException when Prompt tool must have at least one dependency")]
        [Trait("UpdatePhase3", "Fail")]
        public async Task UpdatePhase3_PromptToolNoDependency_ThrowsAppException()
        {
            // Arrange
            var stepDto = WorkflowFixture.FindValidStepDto();
            var stepToolUpdateDto = WorkflowFixture.FindValidStepToolUpdateDto();
            ...
            var workflow = WorkflowFixture.FindValidWorkflow();
            var promptTool = WorkflowFixture.CreateToolModel(1, "Prompt Tool", "Prompt");
        ...
        public async Task UpdatePhase3_ExistingStepToolsOutput_ThrowsAppException()
        {
            ...
            _stepToolOutputRepositoryMock.Setup(sto => sto.HasOutputsByStepToolIds(It.IsAny<List<int>>()))
                .ReturnsAsync(true);
        ...
        public async Task UpdatePhase2_ValidDto_UpdatesWorkflowSuccessfully()
        {
            ...
            _profileRepositoryMock.Setup(x => x.FindById(stepDto.Profile.Id))
                .ReturnsAsync(WorkflowFixture.FindValidProfileDto());
            _statusRepositoryMock.Setup(x => x.FindById(stepDto.Status.Id))
                .ReturnsAsync(WorkflowFixture.FindValidStatus());
        ...
        public async Task FindByTeamId_ShouldReturnWorkflowDto_WhenWorkflowExists()
        {
            ...
            var workflow = new WorkflowDto
            {
                ...
                Steps = new List<StepDto>
                {
                    new StepDto
                    {
                        Id = 1, Name = "Step 1", Cards = new List<CardDto> { new CardDto(), new CardDto() }
                    },
        ...
        public async Task FindStepsById_ShouldReturnSteps_WhenFound()
        {
            ...
            {
                Input = "search", IsAllUsers = true, Login = "user@example.com", OrderBy = "created asc"
            };
        ...
        public async Task FindStepsById_ShouldThrowAppException_WhenNotFound()
        {
            ...
            var filter = new WorkflowFilterDto
            {
                Input = string.Empty, IsAllUsers = false, Login = string.Empty, OrderBy = string.Empty
            };
        ...
        public async Task FindWorkflowsByDocument_ValidDto_ReturnsWorkflows()
        {
            ...
            _workflowRepositoryMock
                .Setup(repo => repo.FindWorkflowsByDocument(requestDto, It.IsAny<CancellationToken>()))
            ...
            _workflowRepositoryMock.Verify(
                repo => repo.FindWorkflowsByDocument(requestDto, It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        [Fact(DisplayName = "UpdatePhase3 should throw AppException when Prompt tool has no dependencies")]
        [Trait("UpdatePhase3", "Fail")]
        public async Task UpdatePhase3_PromptToolNoDependenciesInStep_ThrowsAppException()
        {
            // Arrange
            var stepDto = WorkflowFixture.FindValidStepDto();
            var stepToolUpdateDto = WorkflowFixture.FindValidStepToolUpdateDto();
        ...
        [Fact(DisplayName = "UpdatePhase3 should succeed when Prompt tool has API dependency")]
        [Trait("UpdatePhase3", "Success")]
        public async Task UpdatePhase3_PromptToolWithApiDependency_UpdatesSuccessfully()
        {
            // Arrange
            var stepId = 1;
            var stepOrder = 1;
            ...
            var apiStepTool = new StepTool(10, DateTime.UtcNow, stepId, 999, 1, 1, 1);
            apiStepTool.Step = step;
            step.StepTools.Add(apiStepTool);

            var promptStepToolEntity = new StepTool(20, DateTime.UtcNow, stepId, 2, 2, 2, 2);
            promptStepToolEntity.Step = step;
            step.StepTools.Add(promptStepToolEntity);

            var apiTool = WorkflowFixture.CreateToolModel(999, "API Tool", HandlersTypes.API);
            ...
            _toolRepositoryMock.Setup(x => x.FindModelByIdAsync(It.IsAny<int>()))
                .ReturnsAsync((int id) => id == 999 ? apiTool : id == 2 ? promptTool : apiTool);
        ...
        [Fact(DisplayName = "UpdatePhase3 should throw when Prompt tool depends on OCR")]
        [Trait("UpdatePhase3", "Fail")]
        public async Task UpdatePhase3_PromptToolWithOcrDependency_ThrowsAppException()
        {
            var stepId = 1;
            var stepOrder = 1;

            var ocrStepToolDto = WorkflowFixture.FindValidStepToolUpdateDto();
            ocrStepToolDto.ToolId = 999;
            var promptStepToolDto = WorkflowFixture.FindValidStepToolUpdateDtoWithDependencies();
            promptStepToolDto.ToolId = 2;
            promptStepToolDto.Order = 2;

            var stepToolsList = new List<StepToolUpdateDto> { ocrStepToolDto, promptStepToolDto };
            var workflowPhase3Dto = new WorkflowPhase3Dto
            {
                WorkflowId = 1,
                Steps = { new StepPhase3Dto { Id = stepId, Order = stepOrder, StepTools = stepToolsList } }
            ...
            var ocrStepTool = new StepTool(10, DateTime.UtcNow, stepId, 999, 1, 1, 1);
        ...
        public async Task UpdatePhase1_ShouldAddTeams_ToWorkflow()
        {
            ...
            var workflowUpdatePhase1Dto = new WorkflowUpdatePhase1Dto
            {
                Id = workflowId, Name = "Updated Workflow", Teams = new List<int> { team1Id, team2Id }
            };
        ...
        public async Task UpdatePhase3_StepWithOrderNotFound_ThrowsAppException()
        {
            ...
            var workflowPhase3Dto = new WorkflowPhase3Dto
            {
                ...
                {
                    new StepPhase3Dto { Id = 0, Order = stepOrder, StepTools = new List<StepToolUpdateDto>() }
                }
            };
        ...
        [Fact(DisplayName = "UpdateTeamProfileRelationshipToWorkflow should return early when workflows count is zero")]
        [Trait("UpdateTeamProfileRelationshipToWorkflow", "EarlyExit")]
        public async Task UpdateTeamProfileRelationshipToWorkflow_WorkflowsCountZero_ReturnsEarly()
        {
            var steps = new List<int> { 1, 2, 3 };
            var profile = new Profile("Test Profile", 1, DateTime.UtcNow);
            profile.Teams = new List<Team> { new Team("Team 1", 1, DateTime.UtcNow) };

            _workflowRepositoryMock.Setup(x => x.FindByStep(steps))
                .ReturnsAsync(new List<Workflow>());

            await _workflowServices.UpdateTeamProfileRelationshipToWorkflow(steps, profile);

            _workflowRepositoryMock.Verify(x => x.FindByStep(steps), Times.Once);
            _teamRepositoryMock.Verify(x => x.FindByIdReturnModel(It.IsAny<int>()), Times.Never);
        }

        [Fact(DisplayName = "VerifyWorkflowMatchInOtherTeamProfile should continue when stepIds is empty")]
        [Trait("VerifyWorkflowMatchInOtherTeamProfile", "EarlyExit")]
        public async Task VerifyWorkflowMatchInOtherTeamProfile_StepIdsEmpty_Continues()
        {
            int profileId = 1;
            int teamId = 1;
            var workflows = new List<Workflow> { WorkflowFixture.FindValidWorkflow() };

            var team = new Team("Test Team", teamId, DateTime.UtcNow)
            {
                Profiles = new List<Profile>
                {
                    new Profile("Other Profile", 2, DateTime.UtcNow)
                    {
                        StepProfilePermissions = new List<StepProfilePermission>()
                    }
                }
            ...
            _teamRepositoryMock.Setup(x => x.FindByIdReturnModel(teamId))
                .Returns(team);

            var result = await _workflowServices.VerifyWorkflowMatchInOtherTeamProfile(profileId, teamId, workflows);

            Assert.NotNull(result);
            Assert.Equal(teamId, result.TeamId);
        }

        [Fact(DisplayName = "RemoveTeamWorkflowRelationship should continue when team is null")]
        [Trait("RemoveTeamWorkflowRelationship", "EarlyExit")]
        public async Task RemoveTeamWorkflowRelationship_TeamIsNull_Continues()
        {
            var teamsWorkflowsDto = new List<TeamsWorkflowsDto>
            {
                new TeamsWorkflowsDto { TeamId = 1, Workflows = new List<int> { 1, 2 } }
            };
            ...
            _teamRepositoryMock.Verify(x => x.FindByIdReturnModel(1), Times.Once);
            _workflowRepositoryMock.Verify(x => x.FindByIdsAsync(It.IsAny<ICollection<int>>()), Times.Never);
        }

        [Fact(DisplayName = "UpdatePhase1 should rollback on exception")]
        [Trait("UpdatePhase1", "Fail")]
        public async Task UpdatePhase1_ExceptionOccurs_RollsBack()
        {
            var workflowUpdatePhase1Dto = new WorkflowUpdatePhase1Dto
            {
                Id = 1, Name = "Updated Workflow", Teams = new List<int> { 1 }
            };

            var workflow = WorkflowFixture.FindValidWorkflow();
            _workflowRepositoryMock.Setup(x => x.FindByIdReturnModel(1))
                .ReturnsAsync(workflow);

            _teamRepositoryMock.Setup(x => x.FindByIds(It.IsAny<ICollection<int>>()))
                .Throws(new Exception("Test exception"));

            await Assert.ThrowsAsync<Exception>(() => _workflowServices.UpdatePhase1(workflowUpdatePhase1Dto));
        ...
        [Trait("UpdatePhase3", "EarlyExit")]
        public async Task ResolveDependencies_StepHasNoStepTools_Continues()
        {
            var workflow = new Workflow(1, DateTime.UtcNow, new List<Team>(), "Test Workflow");
            var step1 = new Step(1, DateTime.UtcNow, 1, "Step 1", 1, 1, 1);
            var step2 = new Step(2, DateTime.UtcNow, 1, "Step 2", 2, 1, 1);
            ...
            var workflowPhase3Dto = new WorkflowPhase3Dto
            {
                ...
                Steps = new List<StepPhase3Dto>
                {
                    ...
                    new StepPhase3Dto { Id = 2, Order = 2, StepTools = new List<StepToolUpdateDto>() }
                }
            };
            ...
            _toolRepositoryMock.Setup(x => x.FindModelByIdAsync(It.IsAny<int>()))
                .ReturnsAsync(WorkflowFixture.CreateToolModel(1, "Test Tool", "N8N"));
        ...
        [Fact(DisplayName = "ResolveDependencies should continue when stepTool not found in map")]
        [Trait("UpdatePhase3", "EarlyExit")]
        public async Task ResolveDependencies_StepToolNotFoundInMap_Continues()
        {
            var workflow = new Workflow(1, DateTime.UtcNow, new List<Team>(), "Test Workflow");
            var step = new Step(1, DateTime.UtcNow, 1, "Step 1", 1, 1, 1);
            workflow.Steps.Add(step);
                    ...
                    new StepPhase3Dto
                    {
                        ...
                        StepTools = new List<StepToolUpdateDto>
                        {
                            new StepToolUpdateDto
                            {
                                ...
                                {
                                    new StepToolOutputDependencyDto
                                    {
                                        StepOrder = 1, StepToolOrder = 999
                                    }
                                }
                            }
                        }
        ...
        [Fact(DisplayName = "ValidatePromptTool should throw when dependency is not API or Quiz")]
        [Trait("UpdatePhase3", "Fail")]
        public async Task ValidatePromptTool_NonApiQuizDependency_ThrowsAppException()
        {
            // Arrange
            var stepId = 1;
            var stepOrder = 1;
            ...
            var _stepToolRepositoryMock = _mocker.GetMock<IStepToolDependencyRepository>();
            var stepToolsList = new List<StepToolUpdateDto> { nonOcrStepToolDto, promptStepToolDto };
            var workflowPhase3Dto = new WorkflowPhase3Dto
            {
                WorkflowId = 1,
                Steps = { new StepPhase3Dto { Id = stepId, Order = stepOrder, StepTools = stepToolsList } }
            ...
            var nonOcrTool = WorkflowFixture.CreateToolModel(999, "Non-OCR Tool", "N8N");
            var promptTool = WorkflowFixture.CreateToolModel(2, "Prompt Tool", "Prompt");
            ...
            _toolRepositoryMock.Setup(x => x.FindModelByIdAsync(It.IsAny<int>()))
                .ReturnsAsync((int id) => id == 999 ? nonOcrTool : id == 2 ? promptTool : nonOcrTool);
        ...
        {
            // Arrange
            var dto = new WorkflowCloneRequestDto { SourceWorkflowId = 1, NewName = "" };
        ...
        public async Task UpdatePhase3_ApiToolParameterEncryption_EncryptsSuccessfully()
        {
            ...
            var stepToolDto = new StepToolUpdateDto
            {
                ...
                Parameters = new List<StepToolParameterUpdateDto>
                {
                    ...
                    {
                        Value =
                            "{\"templateId\":3003,\"body\":{\"messages\":[{\"role\":\"system\"}]}}", // Body as object - should be normalized
                    ...
                    {
                        Value =
                            "{\"templateId\":3004,\"body\":\"{\\\"messages\\\":[]}\"}", // Body already as string - should remain
                    ...
                    new StepToolParameterUpdateDto { Value = "already_encrypted_value", WebhookId = webhookId4 }
                }
            };
            ...
            encryptionServiceMock.Setup(s => s.IsEncrypted(It.Is<string>(v => !v.Contains("already_encrypted"))))
                .Returns(false);
