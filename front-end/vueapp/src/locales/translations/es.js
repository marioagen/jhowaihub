const spanish = {
    ...
    common: {
        ...
        thisActionCannotBeUndone: "Esta acción no se puede deshacer. ¿Está seguro de que desea eliminarlo?",
    ...
    documents: {
        ...
        documentTypeError: "Tipo de documento no válido",
        ...
        documentTypeRemoveError: "Error al eliminar tipo de documento",
        ...
        youAreAboutToDeleteDocumentQuery: "Estás a punto de eliminar <br/> el historial de consultas del sistema",
        ...
        uploadFailure: "Fallo en la carga",
        uploadedFiles: "Todos los archivos subidos",
        uploadedFilesError: "Fallo al cargar archivos!",
        uploadComplete: "Carga completa",
        uploadError: "Algo va mal",
    ...
    questions: {
        ...
        questionAlreadyExists: "Pregunta duplicada",
        questionError: "Pregunta no valido",
    ...
    quizzes: {
        ...
        duplicatedQuestionnaire: "Nombre del cuestionario duplicado",
        questionnaireError: "Cuestionario no valido",
        questionnaireSearch: "Nombre, ID, Tipo de documento o inserte un nuevo cuestionario para registrarte",
    ...
    types: {
        ...
        newType: "Crear tipo",
        youAreAboutToDeleteDocumentType: "Estás a punto de eliminar <br/> un tipo de documento del sistema",
    ...
    management: {
        ...
        users: {
            ...
            errorEmailAlreadyExists: "El correo electrónico ya está registrado",
            userError: "Usuario no válido",
            ...
            maxLength: "El número máximo de caracteres es {limit}",
            minLength: "El número mínimo de caracteres es {limit}",
        },
        teams: {
            title: "Equipos",
            ...
            errorTeamAlreadyExists: "Equipo ya registrado",
            teamError: "Equipo no válido",
            searchTeams: "Buscar equipos",
            selectedWithO: "Seleccionados",
        ...
        profiles: {
            ...
            profileRemoveError: "Error al eliminar perfil",
            profileAddError: "Erro al crear perfil",
            profileEditError: "Erro al actualizar perfil",
