const spanish = {
    ...
    analyze: {
        ...
        exportCsvTitle: "Exportar datos de herramientas",
        csvColumns: {
        ...
        approveSuccess: "Documento aprobado y avanzado al siguiente paso.",
    ...
    auditor: {
        ...
        tools: {
            ...
            subtitle: "Registro de cambios en Agentes, Conectores, Plantillas de API y Cuestionarios",
            filters: {
                searchPlaceholder: "Nombre de herramienta o usuario...",
                allCategories: "Todas las categorías",
                searchAria: "Buscar herramienta",
            ...
            summary: {
                empty: "No hay registros de cambios en herramientas.",
                loadMore: "Cargar más",
                eventsCount: "{count} eventos",
            },
            detail: {
                selectTool: "Seleccione una herramienta para ver su historial",
                activityHistory: "Historial de Cambios",
                events: "{count} eventos",
                orderNewest: "Más recientes",
                orderOldest: "Más antiguos",
                allActions: "Todas las acciones",
                actionCreate: "Creación",
                actionUpdate: "Modificación",
                actionDelete: "Eliminación",
                searchPlaceholder: "Buscar por usuario o detalle...",
                searchAria: "Buscar en historial",
                loadMore: "Cargar más",
            },
            categories: {
                agent: "Agente",
        ...
        system: {
            ...
            summary: {
                empty: "No hay eventos del sistema para mostrar.",
                loadMore: "Cargar más",
                eventsCount: "{count} eventos",
    ...
    common: {
        ...
        create: "Crear",
        delete: "Borrar",
        itemsSelected: "registros seleccionados",
    ...
    dashboard: {
        ...
        graphs: {
            ...
            totalTokensValueTooltip:
                "Valor de los tokens registrados en el Hub store multiplicado por el precio unitario. Más información en: <a href='https://www.woopi.ai/planos.html' target='_blank' rel='noopener noreferrer'>woopi.ai/planos.html</a>",
    ...
    management: {
        ...
        users: {
            ...
            csvImport: {
                ...
                errEmailAlreadyExists: "Correo electrónico ya registrado en el sistema",
                alreadyRegisteredLabel: "Ya registrado",
                alreadyRegisteredCount: "ya registrados",
                validating: "Validando...",
                successPartialMsg: "{created} usuarios creados. {skipped} ignorados por ya existir en el sistema.",
            },
        },
    },
    managementQuizzes: {
    ...
    contextDossiers: {
        addFiles: "Agregar archivos", allStatuses: "Todos los estados", confirm: "Confirmar", confidence: "{value}% de confianza",
        contextTitle: "Contexto preparado", contextWorkspace: "Centro de contexto", copied: "Contexto copiado.", columns: { files: "Archivos", name: "Nombre", status: "Estado", updated: "Actualizado", version: "Versión" }, compareFile: "Archivo", compareFrom: "Comparar versión", compareTo: "Con versión",
        createTitle: "Nuevo expediente de contexto", deleteConfirm: "¿Eliminar este expediente?", dispatched: "Envío simulado registrado.", dispatchContent: "Contenido del envío", dispatchFull: "Contexto completo", dispatchFullHint: "Envía el TXT consolidado con todos los archivos de esta versión.", dispatchNotice: "Demostración: no se ejecutará ningún flujo real.", dispatchSelected: "Transcripciones seleccionadas", dispatchSelectedHint: "Envía solo las variables de los archivos seleccionados.", dispatchTitle: "Enviar contexto al flujo", documentType: "Tipo documental", download: "Descargar TXT", duplicate: "Duplicar",
        empty: "No se encontraron expedientes.", fileStatus: { classifying: "Clasificando", failed: "Falló", queued: "En cola", ready: "Listo", review: "Requiere confirmación", transcribing: "Transcribiendo", uploading: "Enviando" },
        fileNotInVersion: "El archivo no existe en esta versión", fileRemoved: "Archivo eliminado del expediente.", filesCount: "{count} archivo(s)", filesTitle: "Archivos", filterStatus: "Filtrar por estado", form: { description: "Descripción (opcional)", name: "Nombre del expediente", nameRequired: "Ingrese un nombre." }, fullContext: "Contexto completo", fullTranscript: "Transcripción completa", hideFiles: "Ocultar panel de archivos", history: "Historial de envíos", individualTranscripts: "Por archivo", moveDown: "Mover abajo", moveUp: "Mover arriba", new: "Nuevo expediente", noComparableFiles: "No hay archivos disponibles para comparar.", noFiles: "Agregue archivos para iniciar la simulación.", noHistory: "No hay envíos simulados.", notFound: "Expediente no encontrado.", prepare: "Preparar contexto", preparedMessage: "Se preparó una nueva versión del contexto.", prototypeNotice: "Prototipo navegable · procesamiento y contenido simulados", removeFile: "Eliminar archivo", removeFileConfirm: "¿Eliminar el archivo {name} de este expediente?", removeFileTitle: "Eliminar archivo del expediente", reset: "Restaurar demostración", resetConfirm: "¿Restaurar todos los datos de demostración?", resultsCount: "{count} resultado(s)", retry: "Intentar de nuevo", search: "Buscar expedientes", selectAtLeastOneVariable: "Seleccione al menos una variable para enviar.", selectFile: "Seleccione un archivo para revisar.", selectType: "Seleccione un tipo", selectVariables: "Variables de esta versión", selectedTranscriptsCount: "{count} transcripción(es)", selectWorkflow: "Seleccione un flujo", send: "Enviar al flujo", showFiles: "Mostrar archivos", simulatedProcessing: "Contenido simulado para prototipo", staleNotice: "El conjunto cambió. Prepare una nueva versión antes de enviar.", status: { draft: "Borrador", failed: "Falla parcial", prepared: "Contexto listo", processing: "Procesando", ready: "Listo para preparar", review: "Requiere revisión", stale: "Desactualizado" }, suggestion: "Sugerencia de IA", tab: "Expedientes de contexto", title: "Expedientes de contexto", transcript: "Transcripción", transcriptChanged: "La transcripción cambió entre versiones.", transcriptUnchanged: "La transcripción es igual en ambas versiones.", typeGroups: { financial: "Financiero", legal: "Jurídico", other: "Otros" }, unidentified: "No identificado", variables: "Variables", versionSnapshot: "Snapshot de la versión {version}", versions: "Versiones", workflow: "Flujo",
        subtitle: "Organice archivos multimodales y simule la preparación de contexto para flujos.",
        typesSettings: { active: "Activo", add: "Agregar tipo", createTitle: "Nuevo tipo documental", deleteConfirm: "¿Eliminar este tipo documental?", editTitle: "Editar tipo documental", group: "Grupo", inactive: "Inactivo", name: "Nombre", notice: "Taxonomía local usada solo por el prototipo de expedientes.", status: "Estado", subtitle: "Gestione las clasificaciones financieras y jurídicas simuladas.", title: "Tipos documentales" },
    },
    settings: {
        ...
        globalVariables: {
            ...
            columns: {
                ...
                type: "Tipo",
                valueOrSource: "Valor u origen",
            },
            created: "Variable global creada correctamente.",
            deleted: "Variable global eliminada correctamente.",
            deleteMessage: "Esta variable dejará de funcionar en todas las herramientas que la usan. ¿Desea continuar?",
            deleteTitle: "Eliminar variable global",
            empty: "No hay variables globales registradas.",
            editRestricted: "Solo el usuario que creó esta variable puede editarla.",
            form: {
                createTitle: "Nueva variable global",
                copyFailed: "No se pudo copiar el valor.",
                copyValue: "Copiar valor",
                commonHint: "Constante reutilizable en cualquier campo compatible.",
                commonVariableRequired: "Seleccione una variable común.",
                clearValue: "Limpiar valor e ingresar otro",
                description: "Descripción (opcional)",
                duplicateName: "Ya existe una variable global con este nombre.",
                editTitle: "Editar variable global",
                environmentHint: "Permite insertar referencias globales en la configuración de herramientas. No crea una variable del sistema operativo.",
                availableAsEnvironment: "Disponible en la configuración de herramientas",
                environmentPlaceholder: "Busque y seleccione una variable común",
                environmentTypeHint: "Usa como valor una variable común ya registrada.",
                hide: "Ocultar valor",
                invalidName: "Comience con una letra y use solo letras, números y guiones bajos.",
                name: "Nombre",
                nameHint: "Comienza con una letra; solo letras, números y guiones bajos.",
                noCommonVariables: "No hay variables comunes disponibles",
                noCommonVariableResults: "No se encontraron variables comunes",
                show: "Mostrar valor",
                secretHint: "Dato sensible que permanece oculto en la interfaz.",
                secretUsageRestriction: "Los secretos solo pueden usarse en headers, cuerpo de la solicitud y campos de credenciales.",
                usage: "Uso en las herramientas:",
                value: "Valor",
                valueType: "Tipo de valor",
                valueCopied: "Valor copiado al portapapeles.",
                valueRequired: "Ingrese un valor para la variable.",
            },
            noDescription: "Sin descripción",
            noResults: "No se encontraron variables para esta búsqueda.",
            noticePrefix: "Use la sintaxis",
            noticeSuffix:
                "en prompts, APIs y otras herramientas. El prefijo global evita conflictos con salidas de pasos y campos del documento. Los valores permanecen ocultos en pantalla.",
            picker: {
                empty: "No hay variables disponibles para este campo",
                insert: "Insertar",
                label: "Seleccionar variable global",
                placeholder: "Seleccionar variable global",
            },
            subtitle: "Registre valores fijos del tenant para reutilizarlos en cualquier herramienta del flujo.",
            pageSummary: "Página {current} de {total}",
            resultsCount: "{count} resultado(s)",
            search: "Buscar por nombre, tipo, origen, descripción o creador",
            ...
            updated: "Variable global actualizada correctamente.",
        },
        apiKeys: {
            add: "Agregar",
            apiUsageNotice:
            ...
            deleteMessage: "La clave \"{name}\" se eliminará de la lista de forma permanente. Esta acción no se puede deshacer.",
            deleteBulkTitle: "Eliminar claves seleccionadas",
            deleteBulkMessage: "{count} clave(s) seleccionada(s) se eliminarán de la lista de forma permanente, independientemente del estado. Esta acción no se puede deshacer.",
            pageSummary: "Página {current} de {total}",
            revoke: "Revocar",
            revokeConfirm: "Revocar",
            revokeTitle: "Revocar clave",
            revokeMessage: "La clave \"{name}\" se desactivará y seguirá listada como revocada. Las integraciones que la usen dejarán de funcionar.",
            revokeBulkMessage: "{count} clave(s) activa(s) serán revocadas y seguirán listadas. Las integraciones que las usen dejarán de funcionar.",
            revoked: "Clave(s) revocada(s) correctamente.",
            empty: "No hay claves registradas. Haga clic en Agregar para generar una nueva.",
            noResults: "Ninguna clave coincide con esta búsqueda.",
            resultsCount: "{count} clave(s)",
            search: "Buscar por nombre o estado",
            status: {
                active: "Activa",
                revoked: "Revocada",
            },
            ...
            titleWithCount: "Gestionar Claves de API ({count})",
        },
        llmModels: {
            activeBadge: "Activo",
