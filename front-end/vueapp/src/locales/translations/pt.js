const portuguese = {
    ...
    contextDossiers: {
        addFiles: "Adicionar arquivos", allStatuses: "Todos os status", confirm: "Confirmar", confidence: "{value}% de confiança",
        contextTitle: "Contexto preparado", contextWorkspace: "Central de contexto", copied: "Contexto copiado.", columns: { files: "Arquivos", name: "Nome", status: "Status", updated: "Atualizado", version: "Versão" }, compareFile: "Arquivo", compareFrom: "Comparar versão", compareTo: "Com versão",
    ...
    settings: {
        ...
        tabs: {
            general: "Geral",
            documentTypes: "Tipos documentais",
        ...
        globalVariables: {
            ...
            columns: {
                ...
                type: "Tipo",
                valueOrSource: "Valor ou origem",
            },
            created: "Variável global criada com sucesso.",
            deleted: "Variável global excluída com sucesso.",
            ...
            form: {
                ...
                commonHint: "Constante reutilizável em qualquer campo compatível.",
                commonVariableRequired: "Selecione uma variável comum.",
                clearValue: "Limpar valor e cadastrar outro",
                description: "Descrição (opcional)",
                duplicateName: "Já existe uma variável global com esse nome.",
                editTitle: "Editar variável global",
                environmentHint: "Permite inserir referências globais nas configurações das ferramentas. Não cria uma variável do sistema operacional.",
                availableAsEnvironment: "Disponível nas configurações das ferramentas",
                environmentPlaceholder: "Busque e selecione uma variável comum",
                environmentTypeHint: "Usa como valor uma variável comum já cadastrada.",
                hide: "Ocultar valor",
                invalidName: "Comece com uma letra e use apenas letras, números e underscore.",
                name: "Nome",
                nameHint: "Começa com letra; apenas letras, números e underscore.",
                noCommonVariables: "Nenhuma variável comum disponível",
                noCommonVariableResults: "Nenhuma variável comum encontrada",
                show: "Mostrar valor",
                secretHint: "Dado sensível sempre mascarado na interface.",
                secretUsageRestriction: "Segredos podem ser usados somente em headers, corpo da requisição e campos de credencial.",
                usage: "Uso nas ferramentas:",
                value: "Valor",
                valueType: "Tipo do valor",
                valueCopied: "Valor copiado para a área de transferência.",
            ...
            picker: {
                empty: "Nenhuma variável disponível para este campo",
                insert: "Inserir",
                label: "Selecionar variável global",
                placeholder: "Selecionar variável global",
            },
            ...
            search: "Buscar por nome, tipo, origem, descrição ou criador",
        ...
        apiKeys: {
            ...
            deleteMessage: "A chave \"{name}\" será removida da listagem permanentemente. Esta ação não pode ser desfeita.",
            deleteBulkTitle: "Excluir chaves selecionadas",
            deleteBulkMessage: "{count} chave(s) selecionada(s) serão removidas da listagem permanentemente, independentemente do status. Esta ação não pode ser desfeita.",
            pageSummary: "Página {current} de {total}",
            revoke: "Revogar",
            revokeConfirm: "Revogar",
            revokeTitle: "Revogar chave",
            revokeMessage: "A chave \"{name}\" será desativada e continuará listada como revogada. Integrações que a utilizam deixarão de funcionar.",
            revokeBulkMessage: "{count} chave(s) ativa(s) serão revogadas e continuarão listadas. Integrações que as utilizam deixarão de funcionar.",
            revoked: "Chave(s) revogada(s) com sucesso.",
            empty: "Nenhuma chave cadastrada. Clique em Adicionar para gerar uma nova.",
            noResults: "Nenhuma chave encontrada para esta busca.",
            resultsCount: "{count} chave(s)",
            search: "Buscar por nome ou status",
            status: {
                active: "Ativa",
                revoked: "Revogada",
            },
            ...
            titleWithCount: "Gerenciar Chaves de API ({count})",
        },
        llmModels: {
            activeBadge: "Ativo",
