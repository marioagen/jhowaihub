...
const NODE_TEXT = 3,
    ...
    getElement = (e) =>
        isElement(e) ? (e.jquery ? e[0] : e) : "string" == typeof e && e.length > 0 ? SelectorEngine.findOne(e) : null,
    typeCheckConfig = (e, t, n) => {
        Object.keys(n).forEach((i) => {
            ...
            if (!new RegExp(s).test(r))
                throw new TypeError(`${e.toUpperCase()}: Option "${i}" provided type "${r}" but expected type "${s}".`);
        });
    },
    isVisible = (e) =>
    ...
    return function i(s) {
        ...
        for (let { target: r } = s; r && r !== this; r = r.parentNode)
            for (let a = o.length; a--; )
                if (o[a] === r)
                    return ((s.delegateTarget = r), i.oneOff && EventHandler.off(e, s.type, t, n), n.apply(r, [s]));
        return null;
    };
}
...
function normalizeData(e) {
    return (
        "true" === e ||
        ("false" !== e && (e === Number(e).toString() ? Number(e) : "" === e || "null" === e ? null : e))
    );
}
...
class Carousel extends BaseComponent {
    ...
    _getConfig(e) {
        return (
            (e = { ...Default$9, ...Manipulator.getDataAttributes(this._element), ...("object" == typeof e ? e : {}) }),
...
(EventHandler.on(document, EVENT_CLICK_DATA_API$5, SELECTOR_DATA_SLIDE, Carousel.dataApiClickHandler),
    EventHandler.on(window, EVENT_LOAD_DATA_API$2, () => {
        ...
        for (let t = 0, n = e.length; t < n; t++) Carousel.carouselInterface(e[t], Carousel.getInstance(e[t]));
    }),
...
class Backdrop {
    ...
    _getConfig(e) {
        return (
            ((e = { ...Default$6, ...("object" == typeof e ? e : {}) }).rootElement = getElement(e.rootElement)),
...
class Modal extends BaseComponent {
    ...
    show(e) {
        this._isShown ||
            ...
            EventHandler.on(this._element, EVENT_CLICK_DISMISS$2, SELECTOR_DATA_DISMISS$2, (e) => this.hide(e)),
    ...
    _adjustDialog() {
        const e = this._element.scrollHeight > document.documentElement.clientHeight,
            ...
            n = t > 0;
        (((!n && e && !isRTL()) || (n && !e && isRTL())) && (this._element.style.paddingLeft = t + "px"),
            ((n && !e && !isRTL()) || (!n && e && isRTL())) && (this._element.style.paddingRight = t + "px"));
    }
    _resetAdjustments() {
...
class Offcanvas extends BaseComponent {
    ...
    show(e) {
        this._isShown ||
            ...
            this._backdrop.show(),
            this._config.scroll || (new ScrollBarHelper().hide(), this._enforceFocusOnElement(this._element)),
            this._element.removeAttribute("aria-hidden"),
            this._element.setAttribute("aria-modal", !0),
            this._element.setAttribute("role", "dialog"),
            this._element.classList.add("show"),
...
const uriAttrs = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
    ...
    allowedAttribute = (e, t) => {
        ...
        if (t.includes(n))
            return (
                !uriAttrs.has(n) || Boolean(SAFE_URL_PATTERN.test(e.nodeValue) || DATA_URL_PATTERN.test(e.nodeValue))
            );
