...
class Carousel extends BaseComponent {
    ...
    _getItemIndex(e) {
        return (
            (this._items =
                e && e.parentNode ? SelectorEngine.find(SELECTOR_ITEM, e.parentNode) : []),
    ...
    _slide(e, t) {
        ...
        if (this._element.classList.contains('slide')) {
            ...
            (i.classList.remove('active'), o.classList.add('active'), (this._isSliding = !1), h())
        a && this.cycle()
    }
    _directionToOrder(e) {
...
class ScrollSpy extends BaseComponent {
    ...
    _activate(e) {
        ...
        ;(n.classList.contains('dropdown-item')
            ? (SelectorEngine.findOne('.dropdown-toggle', n.closest('.dropdown')).classList.add(
                  'active'
              ),
