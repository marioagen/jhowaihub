            ...
            <div class="card-body mt-2">
                <div class="row">
                    <div class="col-12 icons-card">
                        <span class="dot mt-2 m-1"></span>
                        <span class="m-1">{{ item.name }}</span>
                        <div class="custom-margin" v-if="item.isOwner">
                            <input class="form-check-input checkbox m-2" type="checkbox" value="" :id="item.id" @click="countChecks(item.id)">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownIcon">
                                <li @click="redirectToEditPrompt(item.id)"><a class="dropdown-item">{{$t('labelEdit')}}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
