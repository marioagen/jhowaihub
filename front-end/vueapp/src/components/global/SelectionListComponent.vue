    ...
    <div class="card">
      <div class="card-header p-2">
        <div class="d-flex justify-content-between align-items-center mb-2">
          ...
          <div class="float-end">
            <button type="button" class="btn btn-outline-secondary btn-sm me-2 fw-semibold" @click="selectAll">
              <i class="bi bi-check-all"></i>
              {{ $t("labelSelectAll") }}
            </button>
            <button type="button" class="btn btn-outline-secondary btn-sm fw-semibold" @click="clearSelection">
            ...
            <div class="form-check d-flex align-items-center">
              ...
              />
                <div v-if="type === 'user-list'">
                    <label :for="`${id}-${item.id}`" class="form-check-label d-flex align-items-center w-100">
