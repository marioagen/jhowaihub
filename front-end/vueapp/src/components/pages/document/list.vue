    ...
    <main>
        ...
        <div class="container-fluid mt-4">
            <div class="custom-padding">
                ...
                <div
                    class="row"
                    v-if="dataDocument.length === 0 && !loading && (searching || !searching)"
                >
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tbody>
                            ...
                            <tbody>
                                ...
                                <tr v-for="(item, index) in dataDocument" :key="index">
                                    ...
                                    <td class="content-center-middle" style="width: 100px">
                                        <span
                                            class="badge rounded-pill bg-custom-primary"
                                            v-if="item.status == 0"
                                        >
                                            {{ $t('labelNotAnalyzed') }}
                                        </span>
                                        <span
                                            class="badge rounded-pill bg-custom-success"
                                            v-if="item.status == 1"
                                        >
                                            {{ $t('labelAnalyzed') }}
                                        </span>
