                    ...
                    <div class="col-md-12 mb-5">
                        <div class="box-upload-form">
                            <form class="form-upload" @submit.prevent="save">
                                    ...
                                    <label class="label-container">
                                        ...
                                        <span class="clear-button">
                                            <img src="../../../assets/img/icon-dropzone-remove-all.svg" alt="Remove All"
                                                :title="$t('labelRemoveAllDropzone')" @click="confirmationDialog()" />
                                        </span>
                                    </label>
                                ...
                                <div class="mb-1">
                                    <label class="form-label" for="descId">{{ $t("labelDescriptionDocumentNote")
                                    }}</label>
                                    ...
                                    <div class="mb-3 rounded">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                :placeholder="$t('labelSearchTeams')" v-model="searchTerm" />
                                        </div>
                                    </div>
                                        ...
                                        <div v-if="!loading" v-for="team in filteredUsers" :key="team.id" class="p-1">
                                            <div class="form-check d-flex align-items-center">
                                                <input class="form-check-input me-3" type="checkbox"
                                                    :id="`user-${team.id}`" :value="team.id" v-model="selectedTeams" />
