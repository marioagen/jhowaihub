                        ...
                        <table class="table table-bordered-vertical table-striped">
                            <tbody>
                                ...
                                <tr v-for="(item, index) in dataType" :key="index">
                                    ...
                                    <td class="content-center-middle" style="width: 85px">
                                        {{ item.id }}
                                    </td>
                                    <td class="content-left-middle">
        ...
        methods: {
            ...
            setCrumbsData: function () {
                this.crumbsData = [
                    ...
                    {
                        crumb: this.$t('labelTypes'),
                        link: { to: 'Type', queryPage: this.$route.query.page },
                    },
                ]
            },
            ...
            editType: function (item) {
                ...
                api.put('/TypeDoc', paramsReq)
                    ...
                    .catch(function (e) {
                        ...
                        if (e.response.status == 409) {
                            self.alertToast(
                                self.$t('labelDocumentTypeAlreadyExists'),
                                'toast-warning'
                            )
                        } else {
                            console.log(e)
