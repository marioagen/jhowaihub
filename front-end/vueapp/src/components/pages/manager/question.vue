    ...
    <main>
        <div class="container-fluid mt-4">
            <div class="custom-padding">
                ...
                <div
                    class="row"
                    v-if="dataQuestion.length === 0 && !loading && (searching || !searching)"
                >
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tbody>
                ...
                <div class="row scroll-area" v-if="!loading && dataQuestion.length > 0">
                    <div class="table-responsive">
                        <table class="table table-bordered-vertical table-striped">
                            <tbody>
                                ...
                                <tr v-for="(item, index) in dataQuestion" :key="index">
                                    ...
                                    <td class="content-center-middle" style="width: 80px">
                                        {{ item.id }}
                                    </td>
                                    <td class="content-left-middle">
        ...
        methods: {
            ...
            setCrumbsData: function () {
                this.crumbsData = [
                    ...
                    {
                        crumb: this.$t('labelQuestions'),
                        link: { to: 'Question', queryPage: this.$route.query.page },
                    },
                ]
            },
