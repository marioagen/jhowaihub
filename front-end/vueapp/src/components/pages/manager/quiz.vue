<template>
    <main>
        <div class="container-fluid mt-4">
            <div class="custom-padding">
                ...
                <div
                    class="row"
                    v-if="dataQuiz.length === 0 && !loading && (searching || !searching)"
                >
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tbody>
                                <tr class="tr-head-1">
                                    <td style="text-align: center">
                                        ...
                                        &nbsp;{{ $t('labelNoQuestionnairesWereFound') }}.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered-vertical table-striped">
                            <tbody>
                                ...
                                <tr v-for="(item, index) in dataQuiz" :key="index">
                                    ...
                                    <td class="content-center-middle" style="width: 51px">
                                        {{ item.id }}
                                    </td>
                                    <td class="content-left-middle">
                                    ...
                                    <td
                                        class="content-center-middle"
                                        style="width: 164px; font-size: 14px"
                                    >
                                        {{ item.emailCreator }}
                                    </td>
                                    <td
                    ...
                    <div class="col-auto">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center">
                                ...
                                <li
                                    class="page-item"
                                    v-if="pagination.currentPage <= pagination.pageCount - 1"
                                >
                                    <a
                                        class="page-link"
                                        @click="
    ...
    <modal-alert
        ...
        :type="'Confirm'"
        :entity="modalEntity"
        :alertTitle="$t('labelYouAreAboutToDeleteQuestionnaire')"
        ...
        methods: {
            ...
            setCrumbsData: function () {
                this.crumbsData = [
                    ...
                    {
                        crumb: this.$t('labelQuestionnaires'),
                        link: { to: 'Quiz', queryPage: this.$route.query.page },
                    },
                ]
            },
