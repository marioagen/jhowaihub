        ...
        <div class="card">
            <div class="card-body">
                <table class="table table-hover caption-top">
                    ...
                    <thead>
                        <tr>
                            <th class="content-left-middle">
                                {{ $t("labelId") }}
                                <img class="icon-order" src="@/assets/img/order-item.svg" @click="orderList(1)" />
                            </th>
                            <th class="content-left-middle">
                                {{ $t("labelTeamName") }}
                                <img class="icon-order" src="@/assets/img/order-item.svg" @click="orderList(2)" />
                            </th>
                            <th class="content-center-middle">
                                {{ $t("labelMembers") }}
                                <img class="icon-order" src="@/assets/img/order-item.svg" @click="orderList(3)" />
                            </th>
