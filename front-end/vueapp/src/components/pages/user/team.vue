<template>
    <div class="scroll-area mt-3 mb-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <button class="btn btn-primary btn-sm" @click="openModalTeam">
                + {{ $t('labelNewTeam') }}
            </button>
        </div>
                        ...
                        <tr v-for="team in teams" :key="team.id">
                            ...
                            <td class="content-right-middle">
                                <dropdown-menu
                                    ...
                                    @action="handleMenuAction($event, team)"
                                />
                            </td>
                        </tr>
                    </tbody>
        ...
        methods: {
            ...
            setMenuActions: function () {
                this.menuActions = {
                    options: [
                        {
                            label: this.$t('labelEdit'),
                            value: 'edit',
                            icon: require('@/assets/img/edit-outlined.svg'),
                        },
                        {
