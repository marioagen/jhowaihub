        ...
        <div v-if="isExpanded" class="chat-panel">
            ...
            <div class="questionnaire-section">
                ...
                <div class="questionnaire-controls">
                    <select v-model="selectedQuestionnaireId" class="questionnaire-select">
            ...
            <div v-if="questionnaireResults.length > 0" class="results-section">
                ...
                <div class="results-list">
                    <div v-for="(result, index) in questionnaireResults" :key="index" class="result-card">
            ...
            <div class="chat-input-section">
                ...
                <div v-if="output != ''">
                    ...
                    <textarea v-model="output" class="chat-textarea" rows="4"></textarea>
                    <button type="button" class="btn btn-outline-primary" @click="copy">
                        {{ $t("analyze.copy") }}
                    </button>
                    ...
                    if (historyData) {
                        ...
                        for (const questionText of questionTexts) {
                            ...
                            const matchingEntry = sortedHistory.find((item) => {
                                ...
                                const idMatches =
                                    !item.questionnaireId || item.questionnaireId === this.appliedQuestionnaireId;
