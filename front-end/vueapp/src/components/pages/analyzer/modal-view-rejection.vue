<template>
    <ModalComponent id="modalViewRejection" :isLoading="loading" ref="ModalViewRejection">
        <template #header>
        ...
        <template #body>
            <div class="modal-body py-4">
                ...
                <div v-else class="rejection-list" style="max-height: 400px; overflow-y: auto;">
                    <div v-for="(rejection, index) in rejections" :key="index" class="card border mb-3 bg-light">
                        <div class="card-body">
                            <h6 class="text-muted mb-2 upppercase" style="font-size: 0.8rem;">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                                <div>
                                    <small class="text-muted d-block">{{ $t('analyze.justification.rejectedBy')
                                        }}:</small>
                                    <span class="fw-bold">{{ rejection.userName }}</span>
                                </div>
                                <div class="text-end">
                                    <small class="text-muted d-block">{{ $t('analyze.justification.date')
                                        }}:</small>
                    ...
                    <div v-if="rejections.length === 0 && !loading" class="text-center text-muted py-3">
