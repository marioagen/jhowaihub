<template>
    ...
    <ExtractDataModal ref="ExtractModal" @update="handleModalUpdate" />
</template>
<script>
    ...
    methods: {
        ...
        handleModalUpdate(newValue) {
            ...
            if (field.outputType === 'N8N') {
                ...
                this.$emit("field-updated", { id: field.outputId, field: this.fields[index], outputsJson });
            } else {
                this.$emit("field-updated", { id: field.outputId, field: this.fields[index] });
            }
