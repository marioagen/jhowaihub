        ...
        <div class="d-flex">
            <div class="border-end p-2" style="width: 140px;">
                <button 
                    ...
                    :class="{'date-preset-selected': selectedPreset === 'currentMonth'}"
                ...
                <button 
                    class="btn btn-sm w-100 text-start mb-1 date-preset-btn"
                    :class="{'date-preset-selected': selectedPreset === 'lastMonth'}"
                    @click="setLastMonth"
                >
                    Mês passado
                </button>
                <button 
                    class="btn btn-sm w-100 text-start mb-1 date-preset-btn" 
                    :class="{'date-preset-selected': selectedPreset === 'previousSeven'}"
                ...
                <button 
                    class="btn btn-sm w-100 text-start mb-1 date-preset-btn" 
                    :class="{'date-preset-selected': selectedPreset === 'previousNinety'}"
