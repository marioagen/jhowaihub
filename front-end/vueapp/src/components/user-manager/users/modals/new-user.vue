<template>
    ...
    <modal-user-team
        v-if="showModalUserTeam"
        @close="closeModalUserTeam"
    ...
    export default {
        ...
        data() {
            return {
                ...
                selectedTeams: this.userEditing.teams
                    ? this.userEditing.teams.map((u) => u.id)
                    : [],
                searchTerm: '',
                teams: [],
                loading: false,
