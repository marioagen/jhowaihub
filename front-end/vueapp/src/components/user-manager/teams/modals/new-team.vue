            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form ref="formRef">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" :placeholder="$t('labelSearchUsers')" v-model="searchTerm"/>
                                </div>
                            </div>            
                            <div class="mb-3">
                            ...
                            <div class="border rounded p-1 user-list">
                                ...
                                <div v-if="!loading" v-for="user in filteredUsers" :key="user.id" class="p-1">
                                    <div class="form-check d-flex align-items-center">
                                        <input class="form-check-input me-3" type="checkbox" :id="`user-${user.id}`" :value="user.id" v-model="selectedUsers">
                        ...
                        <div class="mb-3">
                            <button type="button" class="btn btn-sm btn-outline-primary w-100" @click="addNewUser"> + {{ $t('labelNewUser')}}</button>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" @click="close"> {{ $t('labelCancel') }} </button>
                    <button type="button" class="btn btn-primary btn-sm" @click="saveTeam" > {{ $t('labelCreate')}} </button>
                </div>
            </div>
        </div>
    </div>
