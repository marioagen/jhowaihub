        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          ">
                ...
                <ul class="dropdown-menu dropdown-menu-sidebar text-small shadow"
                    ...
                    id="tenantDropdownMenu"
                    style="white-space: normal; overflow-wrap: break-word">
                    <li v-for="tenant in tenantsFromState"
                        :key="tenant"
                        class="remove-hover">
                        <label class="dropdown-item"
                               id="tenantDropdownLabel"
            ...
            <div class="dropdown nav-buttons">
                <button class="btn button-nav"
                        type="button"
                        id="flexSwitchCheckThemeOffSidebar"
                ...
                <div class="dropdown" style="float: right">
                    <a class="d-flex align-items-center text-black text-decoration-none dropdown-toggle username"
                       ...
                       aria-expanded="false">
                        <svg width="32"
                             height="32"
                             class="rounded-circle me-2 bd-circle"
                             xmlns="http://www.w3.org/2000/svg"
                             role="img"
                             preserveAspectRatio="xMidYMid slice"
                             focusable="false"
                             v-if="profileImage === ''"></svg>
...
<style scoped>
    ...
    #tenantDropdownButton {
        width: 100%; /* Ajusta o botão para ser responsivo */
    ...
    .circle-icon {
        width: 32px;
        height: 32px;
        background-color: var(--color-bg-btn-primary) !important; /* Cor de fundo padrão */
        text-align: center;
        color: white;
        border-radius: 50%;
        padding-top: 7%;
    ...
    @media (max-width: 768px) {
        ...
        #tenantDropdownButton {
            ...
            padding: 0.5rem; /* Ajusta o espaçamento interno */
        }

        #tenantDropdownMenu {
            width: 100%; /* Garante que o menu dropdown seja responsivo */
            font-size: 0.85rem; /* Ajusta o tamanho da fonte */
        }

        #tenantDropdownLabel {
            font-size: 0.9rem; /* Ajusta o tamanho da fonte no label */
        }
    ...
    #tenantDropdownMenu {
        ...
        #tenantDropdownMenu li {
            ...
            padding: 0.25rem 0.5rem; /* Ajusta o padding dos itens */
        }
