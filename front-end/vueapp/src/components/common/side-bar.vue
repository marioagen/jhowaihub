    ...
    <aside class="sidebar d-flex flex-column flex-shrink-0 background-white text-black">
        ...
        <div class="sidebar-header d-flex align-items-center justify-content-start px-3" style="height: 60px;">
            <router-link class="d-flex align-items-center text-decoration-none w-100" :to="{ name: 'DocumentList' }">
                <img v-if="!showLogoDarkMode && isCollapsed" src="./../../assets/img/woopiai-hub-small-logo.png"
                    :title="$t('labelGoHome')" width="30" height="30" />
                <img v-else-if="!showLogoDarkMode" src="./../../assets/img/woopiai-hub-logo.png"
                    :title="$t('labelGoHome')" width="120" height="40" />
                <img v-else-if="isCollapsed" src="./../../assets/img/woopiai-hub-small-logo.png"
                    :title="$t('labelGoHome')" width="30" height="30" />
                <img v-else src="./../../assets/img/woopiai-hub-logo.png" :title="$t('labelGoHome')" width="186"
                    height="40" />
            </router-link>
        </div>
        ...
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li class="mb-1">
                <router-link :class="[
                    ...
                    <img src="./../../assets/img/docs-analyze.svg" :title="$t('labelDocuments')" width="20"
                        class="icon-sidebar" />
            ...
            <li>
                <router-link :class="[
                    ...
                    <img src="../../assets/img/question-icon.svg" :title="$t('labelQuestions')" width="20"
                        class="icon-sidebar" />
            ...
            <li>
                <router-link :class="[
                    ...
                    <img src="./../../assets/img/questionnaires-icon.svg" :title="$t('labelQuestionnaires')" width="20"
                        class="icon-sidebar" />
