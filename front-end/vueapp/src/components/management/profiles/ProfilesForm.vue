        ...
        >
            ...
            <div class="row mt-1">
                <div class="main-div shadow-sm mt-2">
                    ...
                    <div
                        v-else
                        class="accordion-wrapper-scroll border rounded p-3 workflow-list"
                    >
                        <div
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle() {
                return this.isEdit
                    ? "management.profiles.editTitle"
                    : "management.profiles.createTitle";
            },
            formSubtitle() {
                return this.isEdit
                    ? "management.profiles.editSubtitle"
                    : "management.profiles.createSubtitle";
            },
            filteredPermissions() {
                if (!this.searchTerm) {
