<template>
    <main>
        <Form ref="formRef" v-slot="{ meta }">
            <div class="container-fluid scroll-area mx-4 mt-4">
                <div class="row align-items-center">
                    <div class="col-6">
                        <div class="row">
                            <div class="col-1">
                                <button class="btn btn-outline-primary btn-table btn-sm table-btn"
                                    @click="returnToTable">
                    ...
                    <div class="col-auto ms-auto">
                        <button class="btn btn-primary btn-sm" @click="saveUser" :disabled="!meta.valid">
                    ...
                    <div class="main-div shadow-sm">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <Field type="text" class="form-control form-control-sm" id="userName"
                                        ref="userNameInput" autocomplete="off" name="userName"
                                        :rules="'required|min:3|max:150'" v-model="userData.name"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <Field type="text" class="form-control form-control-sm" id="userEmail"
                                        ref="userEmailInput" autocomplete="off" name="userEmail"
                                        :rules="'required|min:5|max:100|email'" v-model="userData.email"
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <PasswordInputComponent :placeholder="$t('management.users.typePassword')"
                                    :rules="passwordRules" name="userPassword" v-model="userData.password" />
                            </div>
                            <div class="col-6">
                                <label for="userConfirmedPassword" class="form-label fw-semibold mb-0">
                                    {{ $t("management.users.confirmedPassword") }}
                                </label>
                                <PasswordInputComponent :placeholder="$t('management.users.typeConfirmedPassword')"
                                    :rules="confirmedPasswordRules" name="userConfirmedPassword"
                                    v-model="userData.confirmedPassword" />
                            </div>
                        </div>
                        <SelectionListComponent :id="'teams'" :labelPanel="'management.teams.title'"
                            :labelSelectedQuantity="'common.selected'" :labelSearch="'management.teams.searchTeams'"
                            :items="teamsList" :loading="isLoading" :listHeight="'300px'"
        ...
        <div v-if="showTeams" class="main-div shadow-sm mt-2">
            <Form @submit="createTeam" ref="formRefTeam" v-slot="{ meta }">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="teamName" class="form-label fw-semibold mb-0">{{ $t("management.teams.teamName")
                        }}</label>
                        <Field type="text" class="form-control form-control-sm" id="teamName" ref="teamNameInput"
                            autocomplete="off" name="teamName" v-model="teamData.name"
                            :placeholder="$t('management.teams.typeTeamName')" :rules="'required|min:3|max:100'" />
                        <ErrorMessage name="teamName" class="invalid-feedback d-block" />
                    </div>
                </div>
                <div class="col-auto ms-auto">
                    <button class="btn btn-primary btn-sm" :disabled="!meta.valid">
                        <LucideIcon icon="Save" :size="15" />
                        {{ $t("common.save") }}
                    </button>
                </div>
