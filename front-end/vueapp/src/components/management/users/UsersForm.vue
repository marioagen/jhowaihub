            ...
            <Form ref="formRef" v-slot="{ meta }">
                <div class="row align-items-center">
                    <div class="col-6">
                        <div class="row">
                            <div class="col-1">
                                <button type="button" class="btn btn-outline-primary btn-table btn-sm table-btn"
                                    @click="returnToTable">
                    ...
                    <div class="col-auto ms-auto">
                        <button type="button" class="btn btn-primary btn-sm" @click="saveUser" :disabled="!meta.valid">
                    ...
                    <div class="main-div shadow-sm">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <PasswordInputComponent :placeholder="$t(
                            ...
                            <div class="col-6">
                                ...
                                <PasswordInputComponent :placeholder="$t(
                                    ...
                                    " :rules="confirmedPasswordRules
                                        " name="userConfirmedPassword" v-model="userData.confirmedPassword
                                        " />
                            </div>
                        </div>
                        <SelectionListComponent :id="'teams'" :labelPanel="'management.teams.title'"
                            ...
                            :items="teamsList" :loading="isLoading" :listHeight="'300px'" v-model:selectedItems="selectedTeams
                                ">
                            <template #footer>
                                <div class="border-top mt-2 pt-2">
                                    <button type="button" class="btn btn-sm btn-outline-secondary fw-semibold" @click="
                                        openTeamSection
                                    ">
                                        +
                                        {{
        ...
        <div v-if="showTeams" class="main-div shadow-sm mt-2">
            <Form @submit="createTeam" ref="formRefTeam" v-slot="{ meta }">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="teamName" class="form-label fw-semibold mb-0">
                            {{
                                $t(
                        ...
                        <Field type="text" class="form-control form-control-sm" id="teamName" ref="teamNameInput"
                            autocomplete="off" name="teamName" v-model="teamData.name" :placeholder="$t(
