                ...
                <div class="offcanvas-body">
                    ...
                    <div v-else-if="isQuizTool">
                        ...
                        <div class="background-div">
                            <select class="form-select" v-model="idSelected" @change="onQuizSelect">
                                <option v-for="item in quizlist" :key="item.id" :value="item.id">
                                    {{ item.title }}
                                </option>
                            </select>
                        </div>
...
export default {
    ...
    methods: {
        ...
        saveFlowStateLocal(selectedNode, nodes) {
            ...
            const nodesInFlowOrder = startNode ? [startNode, ...orderedToolNodes] : orderedToolNodes;
            const state = {
