            ...
            saveConfiguration() {
                ...
                if (nodeIndex !== -1) {
                    ...
                    if (nodes[nodeIndex].data.parameters.length === 0) {
                        ...
                        nodes[nodeIndex].data.parameters[0].value = this.selectedPromptId
                            ? this.selectedPromptId.toString()
                            : null;
                    }
                    ...
                    this.flowState.nodes = nodes;
                    this.flowState.selectedNode = nodes[nodeIndex];
                    this.flowState.selectedDependencies = this.selectedDependencies;
                    localStorage.setItem("flow_state_params", JSON.stringify(this.flowState));
